...
<div class="container" style="margin-top:50px;">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12 text-center">
          <br>
                <div class="alert alert-primary" role="alert"><h3 class="text-primary" style="cursor:pointer;">
                  Detalles de la Compra <i class="fas fa-money-check-alt"></i></h3></div>
                  <hr>
        </div>
        ...
        <div class="col-md-5 text-center">
                  <h5><span class="badge badge-pill badge-primary" style="width:300px;">Membresia: {{$membresia}}</span><br>

                  <b style="font-size:36px;">Total: ${{number_format($cantidad, 2, ',', ' ')}}</b><br>
                  Vigencia: {{$plan}}
                </h5>
        ...
        <div class="col-md-12 text-center">
          <hr>
          <p>Compra de membresia de inversion Green Oceans Inc 2021.<br> Con esta membresia podras realizar inversiònes y obtener planes especiales y personalizados.</p>
          <br>


          <form action="{{URL::to('/') }}/procesar_pago_cryptocoin" method="post">
              @csrf
              <input value="{{$user->email}}" name="email" hidden/>
              <input value="{{$cantidad}}" name="cantidad" hidden/>
              <input value="{{$plan}}" name="plan" hidden/>
