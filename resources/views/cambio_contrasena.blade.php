...
<div class="container" style="margin-top:50px;">
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
          <hr>
              <div class="text-center">
                <h3>
                   Cambio de PIN Blockchain Conect !! <i class="fas fa-key"></i>
                 </h3>
                 <hr>
                <div class="alert alert-primary" role="alert">
                  Si cambias tu PIN ya no podras desaser el cambio, estas seguro de querer cambiar tu PIN Blockchain?
                </div>
               </div>
        </div>
        ...
        <div class="col-md-4 text-center">
         ...
         <form action="{{URL::to('/') }}/pin_update" method="post">
@csrf
             <input class="form-control" name="email"  value="{{$user->email}}" hidden/>
          <input class="form-control" value="" maxlength="4" style="width:120px; margin-left:35%;" placeholder="PIN anterior." type="password"/>
          <br>
          <input class="form-control" name="pin" value="" maxlength="4" style="width:120px;  margin-left:35%;" placeholder="Nuevo PIN." type="password"/>
          <br>
          <button class="btn btn-success" style="width:100%;">Guardar Cambio <i class="fas fa-check"></i></button>
        </form>
